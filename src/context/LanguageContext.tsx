...
export const translations: Translations = {
  ...
  edit_post_desc_traveler: { en: "Update your traveler details.", ar: "تحديث تفاصيل المسافر الخاصة بك.", fr: "Mettez à jour vos informations de voyage." },
  ...
  traveler_offer_title: { en: "Traveler Offer", ar: "عرض مسافر", fr: "Offre Voyageur" },
  ...
  buyer_request_title: { en: "Buyer Request", ar: "طلب مشتري", fr: "Demande Acheteur" },
  ...
  platform_fee_deal: { en: "Commission from traveler", ar: "عمولة من مسافر", fr: "Commission du voyageur" },
