...
export const translations: Translations = {
  ...
  wallet: { en: "Subscription", ar: "الاشتراك", fr: "Abonnement" },
  ...
  traveler_offer_title: { en: "Traveler Offer", ar: "عرض مسافر", fr: "عرض مسافر" },
  ...
  buyer_request_title: { en: "Buyer Request", ar: "طلب مشتري", fr: "طلب مشتري" },
  ...
  wallet_title: { en: "Traveler Subscriptions", ar: "اشتراكات المسافرين", fr: "Abonnements Voyageurs" },
  wallet_subtitle: { en: "Only travelers pay for deal credits. Buyers use the platform for free.", ar: "المسافرون فقط يدفعون مقابل رصيد العمليات. المشترون يستخدمون المنصة مجاناً.", fr: "Seuls les voyageurs paient. Les acheteurs utilisent la plateforme gratuitement." },
  recharge_funds: { en: "Purchase Deal Credits", ar: "شراء رصيد عمليات", fr: "Acheter des crédits" },
  recharge_subtitle: { en: "Select a package to add successful deal credits to your account.", ar: "اختر باقة لإضافة رصيد عمليات ناجحة إلى حسابك كمسافر.", fr: "Choisissez un forfait pour ajouter des crédits à votre compte." },
  balance_label: { en: "REMAINING OPERATIONS", ar: "العمليات المتبقية", fr: "OPÉRATIONS RESTANTES" },
  balance_subtitle: { en: "Each successful deal consumes 1 operation credit.", ar: "كل عملية ناجحة تستهلك نقطة واحدة من رصيد العمليات.", fr: "Chaque transaction réussie consomme 1 crédit." },
  add_plus: { en: "Purchase", ar: "شراء", fr: "Acheter" },
  transaction_history: { en: "Payment History", ar: "سجل المدفوعات", fr: "Historique des paiements" },
  currency_da: { en: "operations", ar: "عملية", fr: "opérations" },
  currency_da_single: { en: "operation", ar: "عملية", fr: "opération" },
  price_da: { en: "DA", ar: "د.ج", fr: "DA" },
  type_recharge: { en: "Credit Top-up", ar: "شحن رصيد", fr: "Recharge de crédit" },
  type_payment: { en: "Deal Commission", ar: "عمولة عملية", fr: "Commission Transaction" },
  type_payout: { en: "Payout", ar: "سحب", fr: "Retrait" },
  type_commission: { en: "Platform Revenue", ar: "أرباح المنصة", fr: "Revenus Plateforme" },
  recharge_desc: { en: "Purchase of deal credits", ar: "شراء رصيد عمليات", fr: "Achat de crédits" },
  marketplace_fee: { en: "Deduction for successful deal", ar: "خصم مقابل عملية ناجحة", fr: "Déduction pour transaction réussie" },
  platform_fee_deal: { en: "Commission from traveler", ar: "عمولة من مسافر", fr: "Commission du voyageور" },
  recharge_success: { en: "Credits added successfully.", ar: "تم إضافة رصيد العمليات بنجاح.", fr: "Crédits ajoutés avec succès." },
  recharge_failed: { en: "Payment failed. Please try again.", ar: "فشلت عملية الدفع. حاول مرة أخرى.", fr: "Échec du paiement." },
  ...
  complete_deal: { en: "Finalize Deal", ar: "إتمام الصفقة", fr: "Finaliser" },
  ...
  type_message: { en: "Type message...", ar: "اكتب رسالة...", fr: "Éكrire..." },
  edit: { en: "Edit", ar: "تعديل", fr: "Modifier" },
  delete: { en: "Delete", ar: "حذف", fr: "Supprimer" },
  reply: { en: "Reply", ar: "رد", fr: "Répondre" },
  replying_to: { en: "Replying to", ar: "الرد على", fr: "Répondre à" },
  ...
  price_offer_desc: { en: "Propose a price. The other party must accept before finalizing.", ar: "اقترح سعراً. يجب على الطرف الآخر القبول قبل الإتمام.", fr: "Proposeز un prix. L'autre partie doit accepter." },
  ...
  finalize_desc_short: { en: "Satisfied? Finalize to credit the traveler.", ar: "هل أنت راضٍ؟ أتمم الصفقة لتوثيق نجاحها للمسافر.", fr: "Satisfait ? Finalisez pour créditer le voyageur." },
  finalize_now: { en: "Finalize Now", ar: "إتمام وتأكيد الآن", fr: "Finaliser maintenant" },
  ...
  deal_finalized: { en: "Deal Finalized!", ar: "تم إتمام الصفقة بنجاح!", fr: "Transaction finalisée !" },
  incomplete_deal: { en: "Incomplete Deal", ar: "صفقة غير مكتملة", fr: "Transaction incomplète" },
  insufficient_balance: { en: "Traveler lacks deal credits", ar: "رصيد المسافر غير كافٍ لإتمام الصفقة", fr: "Crédits de transaction insuffisants" },
  ...
  insert_link_title: { en: "Insert Media Link", ar: "إدراج رابط ميديا", fr: "Insérer un lien média" },
  ...
  deals: { en: "Successes", ar: "عمليات ناجحة", fr: "Succès" },
  postings: { en: "Postings", ar: "المنشورات", fr: "Annonces" },

  // Admin Dashboard
  admin_center: { en: "Admin Center", ar: "مركز الإدارة", fr: "Centre d'administration" },
  admin_subtitle: { en: "Monitor platform activity and revenue.", ar: "مراقبة نشاط المنصة والإيرادات.", fr: "Surveillez l'activité et les revenus de la plateforme." },
  total_platform_revenue: { en: "Total Platform Revenue", ar: "إجمالي أرباح المنصة", fr: "Revenu total de la plateforme" },
  revenue_tracking_active: { en: "Revenue Tracking Active", ar: "تتبع الأرباح نشط", fr: "Suivi des revenus actif" },
  tab_reports: { en: "Reports", ar: "البلاغات", fr: "Rapports" },
  tab_users: { en: "Users", ar: "المستخدمين", fr: "Utilisateurs" },
  ...
  no_packages_configured: { en: "No packages configured.", ar: "لم يتم تكوين أي باقات.", fr: "Aucun forfait configuré." },
  no_revenue_recorded: { en: "No revenue recorded yet.", ar: "لم يتم تسجيل أي إيرادات بعد.", fr: "Aucun revenu enregistré." },
  admin_only_view: { en: "ADMIN ONLY VIEW", ar: "عرض للمسؤول فقط", fr: "VUE RÉSERVÉE À L'ADMIN" },
  resolve: { en: "Resolve", ar: "حل", fr: "Résoudre" },
  resolved: { en: "Resolved", ar: "تم الحل", fr: "Résolu" },
  edit_package: { en: "Edit Package", ar: "تعديل الباقة", fr: "Modifier le forfait" },
  package_name: { en: "Package Name", ar: "اسم الباقة", fr: "Nom du forfait" },
  credits_label: { en: "Credits", ar: "العمليات", fr: "Crédits" },
  price_da_label: { en: "Price (DA)", ar: "السعر (د.ج)", fr: "Prix (DA)" },
