...
export const translations: Translations = {
  ...
  recharge_subtitle: { en: "Add deal credits to your traveler account.", ar: "أضف رصيد عمليات إلى حساب المسافر الخاص بك.", fr: "Ajoutez des crédits de transaction à votre compte voyageور." },
  ...
  add_plus: { en: "Buy", ar: "شراء", fr: "Acheter" },
  ...
  type_recharge: { en: "Credit Purchase", ar: "شراء رصيد", fr: "Achat Crédit" },
  ...
  recharge_desc: { en: "Credit Purchase", ar: "شراء رصيد عمليات", fr: "Achat de crédits" },
  ...
  recharge_failed: { en: "Purchase failed.", ar: "فشل الشراء.", fr: "Échec de l'achat." },
