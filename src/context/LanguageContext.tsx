...
export const translations: Translations = {
  ...
  wallet_title: { en: "Deals Subscription", ar: "اشتراك العمليات", fr: "Abonnement Transactions" },
  wallet_subtitle: { en: "Manage your deal credits and subscription history.", ar: "إدارة رصيد العمليات وسجل الاشتراكات الخاص بك.", fr: "Gérez vos crédits de transaction et votre historique." },
  recharge_funds: { en: "Top-up Credits", ar: "شحن رصيد عمليات", fr: "Recharger des crédits" },
  recharge_subtitle: { en: "Add deal credits to your traveler account.", ar: "أضف رصيد عمليات إلى حساب المسافر الخاص بك.", fr: "Ajoutez des crédits de transaction à votre compte voyageur." },
  balance_label: { en: "Deal Credits", ar: "العمليات المتاحة", fr: "Crédits Disponibles" },
  balance_subtitle: { en: "Credits remaining for successful deals", ar: "الرصيد المتبقي لإتمام العمليات", fr: "Crédits restants pour les transactions" },
  add_plus: { en: "Top-up", ar: "شحن", fr: "Recharger" },
  transaction_history: { en: "Subscription History", ar: "سجل الاشتراكات", fr: "Historique d'abonnement" },
  currency_da: { en: "Deals", ar: "عمليات", fr: "Transactions" },
  type_recharge: { en: "Credit Top-up", ar: "شحن رصيد", fr: "Recharge Crédit" },
  type_payment: { en: "Deal Commission", ar: "عمولة عملية", fr: "Commission Transaction" },
  type_payout: { en: "Payout", ar: "سحب", fr: "Retrait" },
  type_commission: { en: "Commission Received", ar: "عمولة مستلمة", fr: "Commission Reçue" },
  recharge_desc: { en: "Subscription Top-up", ar: "شحن اشتراك عمليات", fr: "Recharge d'abonnement" },
  marketplace_fee: { en: "Traveler deal commission", ar: "عمولة المسافر عن العملية", fr: "Commission de voyageur sur transaction" },
  platform_fee_deal: { en: "Platform Fee from deal", ar: "عمولة المنصة من العملية", fr: "Frais de plateforme de la transaction" },
  recharge_success: { en: "credits added.", ar: "عمليات أضيفت للرصيد.", fr: "crédits ajoutés." },
  recharge_failed: { en: "Top-up failed.", ar: "فشل الشحن.", fr: "Échec de la recharge." },
  ...
  insufficient_balance: { en: "Insufficient Deal Credits", ar: "رصيد عمليات غير كافٍ", fr: "Crédits de transaction insuffisants" },
  ...
  deals: { en: "Operations", ar: "عمليات", fr: "Transactions" },
